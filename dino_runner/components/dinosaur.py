...
from dino_runner.utils.constants import DUCKING_SHIELD, RUNNING_SHIELD, JUMPING_SHIELD
from dino_runner.utils.constants import RUNNING_HAMMER, DUCKING_HAMMER, JUMPING_HAMMER
